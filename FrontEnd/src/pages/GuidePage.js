...
function GuidePage() {
  ...
  function handleSearch(query) {
    ...
    navigate(`/guide?place=${encodeURIComponent(query)}&date=${encodeURIComponent(initialDate)}`, { replace: true });
  }
    ...
    <div className="container mt-4">
      ...
      <div className="guides-list mt-4">
        {guides.length > 0 ? (
          ...
          <p className="text-center">No guides found matching your search criteria.</p>
        )}
      </div>
    </div>
  );
