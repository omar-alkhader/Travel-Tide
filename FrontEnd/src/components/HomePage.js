    ...
    <div className="homepage-container">
      ...
      <section className="HomePage-places-section py-5">
        ...
        <div className="row align-items-center position-relative mb-5">
          <div className="col-md-3 offset-md-1" style={{ marginTop: "-200px" }}>
          ...
          <button className="HomePage-btn btn btn-outline-dark"
          onClick={() => setIsChatOpen(prevState => !prevState)}>➤ Guide</button>
        </div>
          <div className="col-md-7 position-relative" style={{ height: '850px' }}>
...
<div className="container-fluid px-md-5 mt-5 pt-5">  
  <div className="position-relative" style={{ height: '800px' }}>
    ...
    <div className="position-absolute" style={{ top: '300px', right: '5%', width: '40%', textAlign: 'left' }}>
      <div className="why-us">
        <h2 className="mb-4">Why with us?</h2>
        <p>Because we have a variety of packages and we got a tour guide that can help you in your trip</p>
      </div>
    </div>
    
    {/* First rectangle */}
    <div className="position-absolute" style={{ top: '0', left: '5%', width: '295px' }}>
      <div className="rectangle first-rectangle">
        ...
        <div className="text">
          ...
          <p>There is a variety of packages and plans, choose the that suits you the best.</p>
        </div>
      </div>
    </div>
    
    {/* Second rectangle */}
    <div className="position-absolute" style={{ top: '20px', left: '25%', width: '295px' }}>
      <div className="rectangle second-rectangle">
        ...
        <div className="text">
          ...
          <p>Find the best deals on flights to any destination worldwide</p>
        </div>
      </div>
    </div>
    
    {/* Third rectangle */}
    <div className="position-absolute" style={{ top: '400px', left: '5%', width: '295px' }}>
      <div className="rectangle third-rectangle">
        ...
        <div className="text">
          ...
          <p>There are various hotels that you can choose from the country that you want to visit.</p>
        </div>
      </div>
    </div>
    
        {/* Fourth rectangle */}
        <div className="position-absolute" style={{ top: '420px', left: '25%', width: '295px' }}>
          <div className="rectangle fourth-rectangle">
            <div className="icon">
              <FaMapMarkedAlt size={50} />
                ...
                <div className="text">
                  <h4>Local Guides</h4>
                  <p>Connect with experienced local guides for an authentic experience</p>
                </div>
              </div>
            </div>
          </div>
    ...
    <div className="testimonials-slider-container">
      <div className="testimonials-slider">
        <div 
          ...
          style={{ transform: `translateX(-${currentTestimonialIndex * 396}px)` }}
        >
