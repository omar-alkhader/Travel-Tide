                        ...
                        <div className="flight-section return">
                            <div className="flight-airline">
                                ...
                                <div className="airline-details">
                                    ...
                                    <span className="flight-number">{flight.returnFlight.flightNumber}</span>
                                </div>
                            </div>
                            ...
                            <div className="flight-route">
                                <div className="route-point departure">
                                    ...
                                    <div className="date">{new Date(flight.returnFlight.departure.date).toLocaleDateString()}</div>
                                </div>
                                ...
                                <div className="route-line">
                                    ...
                                    <hr />
                                    <div className="duration">{flight.returnFlight.duration}</div>
                                </div>

                                <div className="route-point arrival">
                                    <div className="time">{flight.returnFlight.arrival.time}</div>
                                    <div className="city">{flight.returnFlight.arrival.city}</div>
                                    <div className="date">{new Date(flight.returnFlight.arrival.date).toLocaleDateString()}</div>
                                </div>
                            </div>
                        </div>
                    </div>
