...
function TravelPackageCard({ package: pkg, onViewFlight }) {
    ...
    return (
        <div className="travel-package-card">
            ...
            {/* Price Details Popup */}
            {showPriceDetails && (
                <div className="price-details-overlay" onClick={() => setShowPriceDetails(false)}>
                    <div className="price-details-popup" onClick={(e) => e.stopPropagation()}>
                        <div className="popup-header">
                            <h4>Price Details</h4>
                            <button className="close-popup" onClick={() => setShowPriceDetails(false)}>×</button>
                        </div>
