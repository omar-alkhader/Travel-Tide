...
function FlightSearchBox({
    ...
    }, [initialDepartureCity, initialArrivalCity, initialDepartureDate, initialReturnDate, initialTravelers]);
    ...
    const handleSearch = () => {
        ...
        navigate(
            `/flights?departureCity=${encodeURIComponent(departureCity)}&arrivalCity=${encodeURIComponent(arrivalCity)}&departureDate=${encodeURIComponent(departureDate)}&returnDate=${encodeURIComponent(returnDate)}&travelers=${encodeURIComponent(travelers)}`,
            { replace: true }
        );
            ...
            <div className="flight-search-info">
                <div className="flight-search-details">
                    <div className="flight-info-group">
                        ...
                        <span>{departureCity && arrivalCity ? `${departureCity} - ${arrivalCity}` : "Not selected"}</span>
                    </div>
